namespace Loupedeck.MouseTronPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.MouseTronPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.MouseTronPlugin.Resources.Resource.txt`.
